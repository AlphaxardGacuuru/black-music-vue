<template>
  <div id="MyElement"
    ...
    <div class="mainMenu d-flex align-items-center justify-content-between">
      ...
      <!-- {/* Nav */} -->
      <div class="sonarNav wow fadeInUp"
           data-wow-delay="1s">
        <nav>
          <ul>
    ...
    <!-- {/* ***** Header Area Start ***** */} -->
    <header style="background-color: #41b883"
            class="header-area">
            ...
            <div class="menu-area d-flex justify-content-between">
              ...
              <div class="menu-content-area d-flex align-items-center">
                ...
                <div class="header-social-area d-flex align-items-center">
                  <router-link v-show="auth.username == '@guest'"
                               class="display-4"
                               to="#"
                               @click="setLogin(true)">
                    Login
                  ...
                  <!-- {/* Avatar Dropdown */} -->
                  <div v-show="auth.username != '@guest'"
                       class="dropdown show">
                    <router-link to="#"
                                 role="button"
                                 id="dropdownMenua"
                    ...
                    <div :style="{
                      ...
                      <router-link to="#"
                                   class="p-3 dropdown-item border-dark"
                                   @click="logout">
                        <h6>Logout</h6>
                      </router-link>
                    </div>
  ...
  methods: {
    ...
    logout(e) {
      ...
      axios.post(`${this.url}/api/logout`).then(() => {
        this.$emit("setState", "message", "Logged out");
        // Update Auth
        this.$emit("setState", "auth", {
          name: "Guest",
          username: "@guest",
  ...
  computed: {
    ...
    showTopnav() {
      if (
        ...
        this.$route.path.match("/post-edit/") ||
